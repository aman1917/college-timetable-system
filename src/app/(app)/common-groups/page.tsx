...
function ClassMultiSelect({
    ...
    return (
        <div className="mt-2">
            ...
            <div
                className={`max-h-64 space-y-1.5 overflow-y-auto rounded-lg border p-3 ${selected.length < 2
                    ? 'border-red-500/50'
                    : 'border-line'
                    }`}
            >
                    ...
                    classes.map((klass) => (
                        ...
                        >
                            ...
                            <span className="text-sm">
                                {klass.year} {klass.stream?.code ?? ''} {klass.division}
                                {' — '}
                                Sem {klass.semester}
                                {' — '}
        ...
        <ResourcePage<CommonGroup>
            config={{
...

                    {
                        ...
                        render: (r) => {
                            ...
                            return r.allocations
                                .map(
                                    (allocation) =>
                                        `${allocation.class.year} ${allocation.class.stream?.code ?? ''} ${allocation.class.division} (Sem ${allocation.class.semester})`,
                                )
                                .join(', ');
                        },
                ...
                toPayload: (v) => {
                    ...
                    /* -----------------------------------------------
                       IMPORTANT:
                       Common Group requires at least 2 classes.
                    ------------------------------------------------ */
